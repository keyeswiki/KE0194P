...
经过前面的蓝牙遥控的原理及应用的学习和了解，经过测试，我们得出了手机APP上各个按钮对应的控制字符，如下图：
...
![image195](../media/c717a7c82b6884f3c6d35cc091bb030d1.png)
...
外接电源，将电机驱动扩展板上的拨码开关拨至ON端。选择好正确的开发板板型和适当的串口端口（COMxx），上传代码。手机APP连接蓝牙，手机APP连接蓝牙成功后，我们可以通过按住蓝牙APP的前进、后退、左转、右转、停止的按钮控制桌面迷你蓝牙智能车分别前进、后退、左转、右转、停止。
